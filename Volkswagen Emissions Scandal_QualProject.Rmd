...
Added line 174 (via GitHub). 

Added line 176 (via RStudio).

Added line 178 (via RStudio).

Added line 180 (via GitHub). 

Added line 182 (via RStudio).

Added line 184 (via GitHub).

Added line 186 (via RStudio).

Added line 188 (via GitHub). 

Added line 190 (via RStudio).

Added line 192 (via GitHub). 

Added line 194 (via RStudio).

Added line 196 (via GitHub). 

Added line 198 (via RStudio).
